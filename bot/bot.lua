...
chats = {}
plugins = {}
helper_username = '@helper_BOT_SToUr_Bot'  -- Input Helper Username Here Without @
...
function create_config( )
  ...
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    sudo_users = {475975207, 363936323, sudo_id},
    admins = {},
    disabled_channels = {},
    moderation = {data = './data/moderation.json'},
    info_text = [[》stour bot v7.0
An advanced administration bot based on https://valtman.name/telegram-cli

》https://t.me/iranb0y

》Admins :
》@iranb0y ➣ Founder & Developer《
》@pouya9998 ➣ Developer《
》@ultra_dev ➣ Developer《
